...
Route::get('winkelwagen/add/{id}', ['as' => 'add_to_cart', 'uses' => 'ShopController@addToCart']);
Route::post('winkelwagen/remove/{id}', ['as' => 'remove_from_cart', 'uses' => 'ShopController@removeFromCart']);
