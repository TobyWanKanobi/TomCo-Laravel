<div class="modal fade" id="edit-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				{!! Form::model($categorie, ['route' => 'save_categorie', 'id' => 'edit-categorie-form']) !!} 
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" id="save-categorie">Opslaan</button>
	...
	$(document).ready(function(){
		...
		$('#save-categorie').click(function(){
			
			$.ajax({
				url : '{!! URL::route('save_categorie'); !!}',
				type: 'post',
				...
				error: function(result) {
					...
					if( result.status === 422 ) {
						...
						$( '#edit-categorie-form' ).append( errorsHtml );
					}
				}
			});
			console.log('hoi');
